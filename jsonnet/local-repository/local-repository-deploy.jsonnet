(import "common/deployment.jsonnet") + {
  ...
  _spec_requests_cpu: $._config.resource.local_repository.requests_cpu,
  _spec_requests_memory: $._config.resource.local_repository.requests_memory,
  _spec_limits_cpu: $._config.resource.local_repository.limits_cpu,
  _spec_limits_memory: $._config.resource.local_repository.limits_memory,
  _spec_image_name:: $._config.local_repository.image_name,
  _spec_probe_enabled:: false,
  _spec_ports:: [
    std.format("lr-port:%s", [
