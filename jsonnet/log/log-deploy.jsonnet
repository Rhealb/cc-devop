(import "common/deployment.jsonnet") + {
  ...
  _spec_requests_cpu: $._config.resource.log.requests_cpu,
  _spec_requests_memory: $._config.resource.log.requests_memory,
  _spec_limits_cpu: $._config.resource.log.limits_cpu,
  _spec_limits_memory: $._config.resource.log.limits_memory,
  _spec_image_name:: $._config.log.image_name,
  _spec_probe_delay: $._config.resource.log.probe,
  _spec_envs:: [
