(import "common/deployment.jsonnet") + {
  ...
  _spec_requests_cpu: $._config.resource.account.requests_cpu,
  _spec_requests_memory: $._config.resource.account.requests_memory,
  _spec_limits_cpu: $._config.resource.account.limits_cpu,
  _spec_limits_memory: $._config.resource.account.limits_memory,
  _spec_image_name:: $._config.account.image_name,
  _spec_probe_delay: $._config.resource.account.probe,
  _spec_envs:: [
