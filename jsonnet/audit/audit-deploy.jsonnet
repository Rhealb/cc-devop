(import "common/deployment.jsonnet") + {
  ...
  _spec_requests_cpu: $._config.resource.audit.requests_cpu,
  _spec_requests_memory: $._config.resource.audit.requests_memory,
  _spec_limits_cpu: $._config.resource.audit.limits_cpu,
  _spec_limits_memory: $._config.resource.audit.limits_memory,
  _spec_image_name:: $._config.audit.image_name,
  _spec_probe_delay: $._config.resource.audit.probe,
  _spec_envs:: [
