...
checkService cc-account console
checkService cc-audit console
checkService cc-backend console
checkService cc-config-server console
checkService cc-console console
checkService cc-gateway system-tools
checkService cc-gc console
checkService cc-gitbook console
checkService cc-harbor console
checkService cc-initializer console
checkService cc-kubeorigin console
checkService cc-log console
checkService cc-metric console
checkService cc-mysql console
checkService cc-notification console
checkService cc-rabbitmq console
checkService cc-redis console
checkService cc-storage console
checkService cc-template console
checkService cc-terminal console
checkService cc-watch console
checkService keycloak console
